...
:meth:`~viff.config.Player.prfs` method gives access to the PRFs.
...
def prss_multiBS(n, j, field, prfs, key, modulus, quantity):
...
def prss_zeroBS(n, t, j, field, prfs, key, quantity):
